          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  if($qother->show_mission_all($_SESSION['npsn_login']) == "No Data"){
                   echo "<tr><td colspan='6'>Tidak ada yang ditampilkan</td></tr>";
                  }
                  else{
                    $no = 1;
                    $group = $qother->show_mission_all($_SESSION['npsn_login']);
