  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <a href="teacher_add_group.php?ex=<?php echo session_id(); ?>" type="button" class="btn bg-gradient-primary"><i class="fas fa-user-cog" style="margin-right: 5px;"></i>Buat Grup</a>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  if($qother->show_group_guru($_SESSION['user_id']) == "No Data"){
                   echo "<tr><td colspan='5'>Tidak ada yang ditampilkan</td></tr>";
                  }
                  else{
                    $no = 1;
                    $group = $qother->show_group_guru($_SESSION['user_id']);
