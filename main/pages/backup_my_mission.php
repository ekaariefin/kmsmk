              ...
              <div class="card bg-light">
                ...
                <div class="card-footer">
                  <div class="text-center">
                    <a href="show_mission_detail_student.php?ex=<?php echo session_id(); ?>&mid=<?php echo $row['mission_id']; ?>" class="btn btn-sm btn-primary">
                      <i class="fas fa-external-link-alt" style="margin-right: 5px;"></i>Info
                    </a>
                    <?php
                    $mission_id = $row['mission_id'];
                    $assignment = $qother->assignment_detail($row['mission_id'],$_SESSION['user_id']);
                    if(empty($assignment['user_file'])){
                      echo '<a href="my_mission_collect.php?ex='.session_id().'&mid='.$mission_id.'"class="btn btn-sm btn-primary">
                      <i class="fas fa-paper-plane" style="margin-right: 5px;"></i>Collect
                    </a>';
                    }
                    else{
