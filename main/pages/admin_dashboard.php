              ...
              <div class="row">
                <div class="col-lg-3 col-6">
                  ...
                  <div class="small-box bg-info">
                    <div class="inner">
                      <h3><?php echo $qother->admin_pusat_count_total_mapel(); ?></h3>
                      <p>Total Mapel</p>
                    </div>
                    <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                  ...
                  <div class="small-box bg-success">
                    <div class="inner">
                      <h3><?php echo $qother->admin_pusat_count_total_knowledge(); ?></h3>
                      <p>Total Knowledge</p>
                    </div>
                    <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                  ...
                  <div class="small-box bg-warning">
                    <div class="inner">
                      <h3><?php echo $qother->admin_pusat_count_total_siswa(); ?></h3>
                      <p>Total Siswa</p>
                    </div>
                    <div class="icon">
                      <i class="fa fa-users"></i>
                    </div>
                    <a href="admin_pusat_userlist.php?ex<?php echo session_id(); ?>" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                  ...
                  <div class="small-box bg-danger">
                    <div class="inner">
                      <h3><?php echo $qother->admin_pusat_count_total_teacher(); ?></h3>
                    ...
                    <a href="admin_pusat_gurulist.php?ex<?php echo session_id(); ?>" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
              </div>
