   ...
   <div class="sidebar">
     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="pimpinan_dashboard.php?ex=<?php echo session_id() ?>" class="nav-link">
         ...
         <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
             <li class="nav-item">
               <a href="add_tacit_pimpinan.php?ex=<?php echo session_id() ?>" class="nav-link">
                 <i class="fa fa-file-alt nav-icon"></i>
                 <p>Tacit Knowledge</p>
               </a>
             </li>
             <li class="nav-item">
               <a href="add_explicit_pimpinan.php?ex=<?php echo session_id() ?>" class="nav-link">
                 <i class="fa fa-file-archive nav-icon"></i>
                 <p>Explicit Knowledge</p>
               </a>
             </li>
