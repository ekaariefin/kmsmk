  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          <center>
            <img src="../../assets/img/tkj.png" style="width: 100px; height: 120px;margin-bottom: 30px">
          </center>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $qother->count_total_knowledge(); ?></h3>
                <p>Total Knowledge</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $qother->count_total_siswa(); ?></h3>
