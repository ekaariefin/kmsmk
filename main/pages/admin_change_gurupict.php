<?php
  ...
  if(isset($_POST['submitFoto'])){
    ...
    if ($size < 1000000){
      ...
      if($quser->update_guru_photo($user_id,$user_photo))
      {
        header('location:admin_show_gurudetail.php?id='.$user_id.'&ex='.session_id().'');
      }
    }else{
        header('location:admin_show_gurudetail.php?id='.$user_id.'&ex='.session_id().'&message=error_upload');
    }
  }
?>
<!DOCTYPE html>
<html>
  <?php 
    ...
    $user_show = $quser->admin_change_user_photo($_GET['id']);
  ?>
          ...
          <div class="col-4">
            <div class="card card-success">
              ...
              <div class="card-body" style="height: 280px">
                <center>
                  <img class="profile-user-img img-fluid img-circle" src="files/user_photo/<?php echo $user_show['user_photo']; ?>" alt="User profile picture" style="width:180px; height:180px;margin-top: 25px;margin-bottom: 10px">
                </center>
              </div>
              <!-- /.card-body -->
            </div>
              ...
              <div class="card-body">
               <div class="callout callout-info">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <input type="file" class="form-control" name="user_photo" accept="image/jpg,image/jpeg" style="height:45px;margin-bottom:20px;">
