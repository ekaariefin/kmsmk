          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <a href="my_tacit.php?ex=<?php echo session_id() ?>" type="button" class="btn btn-success" style="margin-bottom: 5px; margin-right: 5px; margin-top: 5px; margin-left: 5px;"><i class="fas fa-tags" style="margin-right: 5px;"></i>Seluruh Kategori</a>

                <?php
                  foreach($qmp_list as $mp) {
                ?>

                <a href="my_tacit.php?mpid=<?php echo $mp['mapel_id']; ?>&ex=<?php echo session_id() ?>" type="button" class="btn btn-primary" style="margin-bottom: 5px; margin-right: 5px; margin-top: 5px; margin-left: 5px;"><i class="fas fa-tags" style="margin-right: 5px;"></i><?php echo $mp['mapel_name']; ?></a>
          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              <div style="margin-bottom: 10px">
                <a href="add_tacit.php" class="btn btn-block btn-primary" style="width: 200px">
