...
$mission_show_progress = $qother->count_kontribusi($mid,$_SESSION['user_id']);
          ...
          <table class="table table-bordered" style="margin-bottom: 30px">
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $mission_show_progress['total_kontribusi']; ?> / <?php echo $mission_show['mission_target']; ?>
                  <?php
                    if($mission_show_progress['total_kontribusi'] < $mission_show['mission_target']){
                      echo "<b>(Belum Tercapai)</b>";
                    }
                    else{
                      echo "<b>(Tercapai)</b>";
                    }
              ...
              <tr>
                <td>Pembina</td>
                <td><?php echo $mission_show['user_name']; ?></td>
              </tr>
              <tr>
                <td>Jumlah Siswa</td>
                <td>
