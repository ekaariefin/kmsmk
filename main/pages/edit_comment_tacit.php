...
$comment_id = $_GET['comment'];
  ...
  {
    $show = $qtacit->tacit_edit_comment($comment_id);
  }
  else
  {
  ...
  if(isset($_POST['editTacitComment'])){
    $comment_id = $_POST['comment_id'];
    $comment_desc = $_POST['comment_desc'];
    $tacit_id = $_POST['tacit_id'];
    echo $comment_id;
    echo "<br/>";
    echo $comment_desc;
    if($qtacit->tacit_save_comment($comment_id, $comment_desc)){
      header('location:show_tacit.php?id='.$tacit_id.'&ex='.session_id().'');
    }
  }
?>
<!DOCTYPE html>
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <div style="position: relative; float:right; margin-bottom: 10px">
            <button type="submit" name="editTacitComment" class="btn btn-info" style="width: 150px"><i class="far fa-save" style="margin-right: 5px"></i> Simpan</button>
          </div>
          <table class="table table-bordered" style="width: 100%; margin-bottom: 30px">
            <tbody>
              ...
              <input type="hidden" name="tacit_id" value="<?php echo $_GET['tacit_id']; ?>">
                <td>Komentar</td>
