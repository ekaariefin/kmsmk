            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <center>
                                <img src="../../assets/img/diknas.png" style="width: 160px; height: 120px; margin-bottom: 50px;">
                            </center>
                            <div class="row">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-info">
                                        <div class="inner">
                                            <h3><?php echo $qother->count_all_mapel($_SESSION['npsn_login']); ?></h3>
                                            <p>Total Mapel</p>
                                        </div>
                                        <div class="icon">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        <div class="inner">
                                            <h3><?php echo $qother->count_total_teacher($_SESSION['npsn_login']); ?></h3>
                                        ...
                                        <a href="admin_gurulist.php?ex<?php echo session_id(); ?>" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                            </div>
